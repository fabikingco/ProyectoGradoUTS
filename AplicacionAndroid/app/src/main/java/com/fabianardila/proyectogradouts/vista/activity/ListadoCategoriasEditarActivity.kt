...
class ListadoCategoriasEditarActivity : AppCompatActivity(), CategoriasAdapter.ClickCategorias {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firestoreService.getCategorias(object : Callback<List<Categoria>> {
            override fun onSuccess(result: List<Categoria>?) {
                runOnUiThread {
                    Toast.makeText(this@ListadoCategoriasEditarActivity, "Cantidad " + result!!.size.toString(), Toast.LENGTH_LONG).show()
    ...
    override fun onClickCategoriaListener(categoria: Categoria) {
        ...
        intent.setClass(this@ListadoCategoriasEditarActivity, ListadoLibrosEditarActivity::class.java)
