...
class LibrosEditarAdapter (val librosAdapterListener: LibrosAdapterListener):
    RecyclerView.Adapter<LibrosEditarAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btnAlquilarLibro.text = "EDITAR LIBRO"
